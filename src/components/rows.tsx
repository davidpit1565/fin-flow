 ...
 *  `.swipe-track`). The drag gesture is pure physical pixel math
 *  (`dx = e.clientX - start.x`, translateX on the track); `leftAction`/
 *  `rightAction` are positioned in CSS via `.swipe-action-left`/
 *  `.swipe-action-right` (index.css). */
